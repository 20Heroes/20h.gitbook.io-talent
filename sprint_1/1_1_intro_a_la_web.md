...
Cuándo escribimos una dirección web en el navegador (Chrome, Firefox, Edge...) como por ejemplo _google.es_, pasan varias cosas:
...
El servidor DNS responde con la IP asociada a ese dominio (en este caso _216.58.211.206_).
